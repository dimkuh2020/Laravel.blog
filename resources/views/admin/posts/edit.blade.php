                        ...
                        <form role="form" method="post" action="{{ route('posts.update', ['post' => $post->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    @if (!$post->thumbnail)
                                        <div><img src="{{ asset('/storage/images/no-image.jpg')}}" alt="" class="img-thumbnail mt-2" width="200"></div>
                                    @else
                                        <div><img src="{{ asset('/storage/' . $post->thumbnail) }}" alt="" class="img-thumbnail mt-2" width="200"></div>
                                    @endif
                                </div>
                            </div>
                            <!-- /.card-body -->
